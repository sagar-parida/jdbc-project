...
public class OrderDAO extends DataAccessObject<Order> {
    ...
    private final static String GET_BY_ID = "SELECT c.first_name, c.last_name, c.email, o.order_id, " +
            ...
            "p.code, p.name, p.size, p.variety, p.price FROM orders o JOIN customer c on o.customer_id " +
            "= c.customer_id JOIN salesperson s on o.salesperson_id = s.salesperson_id JOIN order_item ol on " +
